...
JS
  ...
  def remove_bootstrap
    gsub_file('app/assets/stylesheets/application.scss', '@import "bootstrap/scss/bootstrap";', '')
    gsub_file('app/assets/stylesheets/application.scss', '@import "config/bootstrap_variables";', '')
